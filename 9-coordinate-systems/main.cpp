...
int main() {
    ...
    glm::mat4 projection = glm::perspective(
        glm::radians(40.0f), static_cast<float>(WINDOW_WIDTH) / WINDOW_HEIGHT, 0.1f, 100.0f);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for (size_t i = 0; i < sizeof(cubePositions) / sizeof(glm::vec3); i++) {
            ...
            if (i % 3 == 0) {
                model = glm::rotate(model, static_cast<float>(glfwGetTime()) * glm::radians(20.0f), glm::vec3(1.0f, 0.3f, 0.5f));
            } else {
