...
int main() {
    ...
    Shader cube_shader("shader.vs", "shader-spot-light.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        cube_shader.setFloat("light.innerCutOff", glm::cos(glm::radians(12.5f)));
        cube_shader.setFloat("light.outerCutOff", glm::cos(glm::radians(18.5f)));
