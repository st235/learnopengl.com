...
// container as if the letters emit light: learnopengl.com/img/textures/matrix.jpg.
// Solution: /src/2.lighting/4.4.lighting_maps_exercise4/;
...
int main() {
    ...
    Shader cube_shader("shader.vs", "shader_em.fs");
    ...
    int emissionMapTexture = BindTexture("emission_map.jpg", GL_RGB, GL_RGB);
