...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        transformation = glm::rotate(transformation, static_cast<float>(glfwGetTime()), glm::vec3(0.0, 0.0, 1.0));
        ...
        glUniformMatrix4fv(inMatrixLoc, 1, GL_FALSE, glm::value_ptr(transformation));
